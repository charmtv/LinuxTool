...
米粒Linux工具是一个功能强大的Linux服务器管理工具集，提供多种系统管理、网络配置、文件操作等功能。

TG群：[@https://t.me/mlkjfx6](https://t.me/mlkjfx6)
...
大陆服务器
```bash
curl -L @https://mlsb.art/https://raw.githubusercontent.com/charmtv/LinuxTool/main/Linux.sh -o Linux.sh && chmod +x Linux.sh && bash Linux.sh
```
境外服务器
```bash
curl -L https://raw.githubusercontent.com/charmtv/LinuxTool/main/Linux.sh -o Linux.sh && chmod +x Linux.sh && bash Linux.sh
```
仅使用Linux换源脚本
```bash
